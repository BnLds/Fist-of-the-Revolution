...
public class Wander : BaseState
{
    ...
    public override void Enter()
    {
        ...
        Vector3 _wanderPoint = new Vector3(PlayerController.Instance.transform.position.x + Random.Range(0f, 10f), PlayerController.Instance.transform.position.y, PlayerController.Instance.transform.position.z + Random.Range(0f, 10f));
    ...
    public override void UpdatePhysics()
    {
        ...
        float wanderPointReachedRange = 2f;
        //check if the policeman is within distance of the wander point
        if (Utility.Distance2DBetweenVector3(_wanderPoint, _policeUnitSM.transform.position) < wanderPointReachedRange)
        {
